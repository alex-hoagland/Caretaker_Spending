...
data out.all_hospitalizations; 
   ...
   ids.definedone();
        ...
        set in.ms_i_2006(keep=enrolid age adm: dx: pproc proc: year plankey) 
   ...
   * (using Card et al. QJE 2009/2010)	  *
   *--------------------------------------*/; 

	* Top 10 non-deferrable conditions; 
		if (dx1 in: ('49121', '51881', 'J9600', 'J9690', '41041', 'I2119', '41011', 'I2109', '82021', 'S72143A', 'S72146A', '4349', '78039', '49391', 'J45902') or 
			substr(dx1,1,3) in: ('431', '496') or substr(dx1,1,4) in: ('J441', 'I619', 'IJ449', 'I669', 'R569') or
		    dx2 in: ('49121', '51881', 'J9600', 'J9690', '41041', 'I2119', '41011', 'I2109', '82021', 'S72143A', 'S72146A', '4349', '78039', '49391', 'J45902') or 
			substr(dx2,1,3) in: ('431', '496') or substr(dx2,1,4) in: ('J441', 'I619', 'IJ449', 'I669', 'R569') or
		    dx3 in: ('49121', '51881', 'J9600', 'J9690', '41041', 'I2119', '41011', 'I2109', '82021', 'S72143A', 'S72146A', '4349', '78039', '49391', 'J45902') or 
			substr(dx3,1,3) in: ('431', '496') or substr(dx3,1,4) in: ('J441', 'I619', 'IJ449', 'I669', 'R569') or
		    dx4 in: ('49121', '51881', 'J9600', 'J9690', '41041', 'I2119', '41011', 'I2109', '82021', 'S72143A', 'S72146A', '4349', '78039', '49391', 'J45902') or 
			substr(dx4,1,3) in: ('431', '496') or substr(dx4,1,4) in: ('J441', 'I619', 'IJ449', 'I669', 'R569')) then nondef = 1; 

	* Keep only relevant claims; 
	if preventable_hospitalization = 1 or nondef = 1; 
run; 

*Export claims; 
proc export data=out.all_hospitalizations
    outfile = "/projectnb2/marketscan/caretaking/allfirms_HospitalizationTypes.dta"
    dbms=stata
    replace;
run;
