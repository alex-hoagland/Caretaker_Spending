...
data out.maintenance_costs_hcc118_op; 
   if _N_=1 then do;
   declare hash ids(dataset:"out.pe_maintenancesample_hcc118");
...
proc sql; 
   create table out.maintenance_costs_hcc118_op as 
   select enrolid, hcc, year, sum(oop) as op_oop, sum(pay) as op_pay from out.maintenance_costs_hcc118_op
...
data out.maintenance_costs_hcc118_op; 
   set out.maintenance_costs_hcc118_op;
