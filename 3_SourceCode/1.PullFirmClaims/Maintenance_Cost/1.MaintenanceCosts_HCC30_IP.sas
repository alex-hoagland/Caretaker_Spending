...
data out.maintenance_costs_hcc30_ip; 
   if _N_=1 then do;
...
proc sql; 
   create table out.maintenance_costs_hcc30_ip as 
   select enrolid, hcc, year, sum(oop) as ip_oop, sum(pay) as ip_pay from out.maintenance_costs_hcc30_ip
...
data out.maintenance_costs_hcc30_ip; 
   set out.maintenance_costs_hcc30_ip;
