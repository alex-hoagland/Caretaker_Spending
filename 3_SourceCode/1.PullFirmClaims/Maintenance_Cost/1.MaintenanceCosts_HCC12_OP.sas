...
data out.maintenance_costs_hcc12_op; 
   if _N_=1 then do;
    ...
    *12     "50+ Breast and Prostate Cancer";
	...
	dx2 in: ('C4A0', 'C4A10', 'C4A11', 'C4A12', 'C4A20', 'C4A21', 'C4A22', 'C4A30', 'C4A31', 'C4A39', 'C4A4', 'C4A51', 'C4A52', 'C4A59', 'C4A60', 'C4A61', 'C4A62',
		...
		'20900', '20901', '20902', '20903', '20910', '20911', '20912', '20913', '20914', '20915', '20916', '20917', '20920', '20921', '20922', '20923', '20924', 
		'20925', '20926', '20927', '20929', '20930', '20931', '20932', '20933', '20934', '20935', '20936', '2250', '2251', '2252', '2253', '2254', '2258', '2259', 
		'2273', '2274', '22802', '2370', '2371', '2373', '2375', '2376', '2379', '2396', '7595', '7596')) then hcc = 12; 
...
proc sql; 
   create table out.maintenance_costs_hcc12_op as 
   select enrolid, hcc, year, sum(oop) as op_oop, sum(pay) as op_pay from out.maintenance_costs_hcc12_op
...
data out.maintenance_costs_hcc12_op; 
   set out.maintenance_costs_hcc12_op;
