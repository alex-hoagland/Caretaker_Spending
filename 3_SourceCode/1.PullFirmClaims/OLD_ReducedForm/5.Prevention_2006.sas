...
data out.outpatient2006(compress=yes); 
   ...
   ids.definedone();
        ...
        set in.ms_o_2006(keep=enrolid year sex dx1 dx2 proc1 pay cob copay coins ded:); 
   ...
   if ((proc1 in: ('96372', '57170', '58340', '58565', '58600', '58605', '58611', '58615', '58670', '58671', 
       ...
       dx2 in: ('V2501', 'V2502', 'V2503', 'V2509', 'V2511', 'V2512', 'V2513', 'V2540', 'V2541', 'V2542', 'V2543',
		...
		'Z3009', 'Z3040', 'Z3041', 'Z3042', 'Z30430', 'Z30431', 'Z30432', 'Z30433', 'Z3049', 'Z308', 'Z309')) and
   ...
   if ((dx1 in: ('V6542', 'V6549', 'V791', 'Z7189', 'Z1389', 'Z7141') or 
       dx2 in: ('V6542', 'V6549', 'V791', 'Z7189', 'Z1389', 'Z7141')) and  
   ...
   if ((dx1 in: ('V103', 'V1043', 'V163', 'V1641', 'Z803', 'Z8041', 'Z1501', 'Z1502', 'Z853', 'Z8543') or 
       dx2 in: ('V103', 'V1043', 'V163', 'V1641', 'Z803', 'Z8041', 'Z1501', 'Z1502', 'Z853', 'Z8543')) and  
       sex = 2 and 
   ...
   if ((dx1 in: ('V700', 'V7231', 'V7232', 'V762', 'Z0000', 'Z0001', 'Z01419', 'Z124') or 
       dx2 in: ('V700', 'V7231', 'V7232', 'V762', 'Z0000', 'Z0001', 'Z01419', 'Z124')) and  
       sex = 2 and 
   ...
   if ((dx1 in: ('V160', 'V1851', 'V1859', 'V700', 'V7262', 'V7641', 'V7650', 'V7651', 'Z0000', 'Z0001', ' Z1210', 'Z1211', 'Z1212', 'Z800', 'Z8371', 'Z8379') or 
       dx2 in: ('V160', 'V1851', 'V1859', 'V700', 'V7262', 'V7641', 'V7650', 'V7651', 'Z0000', 'Z0001', ' Z1210', 'Z1211', 'Z1212', 'Z800', 'Z8371', 'Z8379')) and 
   ...
   if ((dx1 in: ('V202', 'V700', 'V035', 'V036', 'V037', 'V0381', 'V0382', 'V0389', 'V040', 'V042', 'V043', 'V046', 'V048', 'V0481', 'V0489', 'V053', 'V054', 'V061', 'V062', 'V063', 'V064', 'V065', 'V066', 'V068', 'V069', 'Z00121', 'Z00129', 'Z0000', 'Z0001', 'Z0001', 'Z23') or 
       dx2 in: ('V202', 'V700', 'V035', 'V036', 'V037', 'V0381', 'V0382', 'V0389', 'V040', 'V042', 'V043', 'V046', 'V048', 'V0481', 'V0489', 'V053', 'V054', 'V061', 'V062', 'V063', 'V064', 'V065', 'V066', 'V068', 'V069', 'Z00121', 'Z00129', 'Z0000', 'Z0001', 'Z0001', 'Z23')) and 
   ...
   if ((dx1 in: ('V202', 'V7791', 'Z00129', 'Z13220') or 
       dx2 in: ('V202', 'V7791', 'Z00129', 'Z13220')) and 
