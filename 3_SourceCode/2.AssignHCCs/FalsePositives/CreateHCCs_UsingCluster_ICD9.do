...
use "/projectnb2/marketscan/caretaking/`1'_Claims_`2'.dta", clear
******************************
...
keep enrolid year dx* // newdate dxver
...
save "/projectnb2/marketscan/caretaking/AllEnrollees_HCCs_`1'_`2'.dta", replace
rm "/projectnb2/marketscan/caretaking/`1'_Claims_`2'.dta"
